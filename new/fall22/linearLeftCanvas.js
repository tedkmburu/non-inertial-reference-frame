const leftCanvasObject = canvas => {
    canvas.preload = function() 
    {
        ...
        cannonImg1 = canvas.loadImage('images/cannon.png'); 
        cannonImg2 = canvas.loadImage('images/cannon2.png'); 
        cannonImg3 = canvas.loadImage('images/cannon3.png'); 
    ...
    {        
        ...
        cannonBalls[0] = new CannonBall({
            pos: canvas.createVector(canvas.width/3, canvas.height / 2),
